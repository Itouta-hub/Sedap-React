...
function Typography(){
    return (
        <div>
            <h1 className="text-3x1 m-6 font-bold text-blue-600">Tailwind Typography</h1>
            <p className="text-gray-600 m-6 text-lg mt-2">Belajar Tailwind sangat menyenangkan dan cepat!</p>
        </div>
    )
}
...
function BorderRadius(){
    return (
        ...
        px-4 py-2 rounded-lg"> Klik Saya </button>
    )
}
